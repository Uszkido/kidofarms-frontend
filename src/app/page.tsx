        ...
        <div className="bg-primary/95 backdrop-blur-xl border-b border-white/10 py-3 sticky top-20 z-50 shadow-2xl">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto relative group">
              ...
              <input
                type="text"
                placeholder="Search for organic vegetables, fresh catfish, or seasonal fruits..."
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
              {[
                ...
                { name: "Fresh Catfish (2kg)", farmer: "Kido Fishery", price: "₦8,500", rating: 4.8, image: "https://images.unsplash.com/photo-1555074213-911855e4be62?q=80&w=2000" },
              ...
              <div className="relative h-[800px] w-full bg-white/5 rounded-[4rem] border border-white/10 overflow-hidden shadow-2xl">
                ...
                <div className="p-16 space-y-12">
                  ...
                  {[
                    ...
                    { name: "Live Mature Catfish", qty: "2,400 Units", change: "+24%" },
