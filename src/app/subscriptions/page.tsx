...
import { Check, ArrowRight, Leaf, ShieldCheck, Truck } from "lucide-react";
                        ...
                        <div className="grid md:grid-cols-2 gap-20 items-center max-w-6xl mx-auto">
                            ...
                            <div className="space-y-12">
                                <div className="space-y-6">
                                    ...
                                    <ul className="grid grid-cols-1 gap-4">
                                        {[
                                            ...
                                            "Choice of whole grains or fresh catfish (optional add-on)",
                                ...
                                <div className="bg-primary p-12 rounded-[3rem] text-white space-y-8 shadow-xl relative overflow-hidden">
                                    ...
                                    <button className="w-full bg-secondary text-primary py-5 rounded-full font-bold text-lg hover:bg-white transition-all shadow-lg flex items-center justify-center gap-3 relative z-10">
                                        Subscribe Now
                                        <ArrowRight size={22} />
                                    </button>
