    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                ...
                images: imageUrl ? [imageUrl] : ["https://images.unsplash.com/photo-1542838132-92c53300491e?w=800"], // Fallback image
            };
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        <div className="bg-white p-10 rounded-[3rem] border border-primary/5 shadow-sm space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 pt-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="text" name="farm_source" value={form.farm_source} onChange={handleChange}
                        ...
                        <div className="bg-white p-10 rounded-[3rem] border border-primary/5 shadow-sm space-y-8">
                            ...
                            {imageUrl && (
                                <div className="w-48 h-48 rounded-2xl overflow-hidden border border-primary/10 relative">
