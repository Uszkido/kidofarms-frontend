...
export const categoryEnum = pgEnum("category", ["Fruits", "Vegetables", "Grains", "Catfish"]);
...
export const products = pgTable("products", {
    ...
    category: text("category").notNull(), // Matching the enum string for now or use categoryEnum
