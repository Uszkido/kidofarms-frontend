...
export default function NewHarvestPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setSuccess(true);
                setTimeout(() => router.push("/dashboard/supplier"), 2000);
            } else {
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pt-12">
                    <div className="space-y-4">
                        <Link href="/dashboard/supplier" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-primary/30 hover:text-primary transition-all mb-4">
