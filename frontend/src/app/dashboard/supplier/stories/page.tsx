                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                            <div>
                                <Link href="/dashboard/supplier" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-primary/40 hover:text-primary mb-4 transition-all">
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-primary/20 backdrop-blur-md">
                    <div className="bg-white w-full max-w-xl rounded-[4rem] p-12 shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="relative space-y-8">
                            <div>
                                <h1 className="text-4xl font-extrabold font-serif tracking-tighter uppercase">Broadcast <span className="text-secondary italic">Now</span></h1>
                                <p className="text-primary/40 font-medium text-sm mt-2">Publish a live harvest moment.</p>
                            </div>
                            ...
                            <form onSubmit={handlePublish} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        required maxLength={100} rows={3} placeholder="Describe this harvest moment..."
                                ...
                                <div className="flex gap-4 pt-4">
                                    ...
                                    >
                                        {isSubmitting ? <Loader2 className="animate-spin" size={20} /> : "Publish to Horizon"}
                                    </button>
                                </div>
                            </form>
                        </div>
