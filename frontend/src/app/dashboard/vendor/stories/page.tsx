...
export default function VendorStoriesPage() {
    ...
    const startCamera = async () => {
        try {
            ...
            alert("Hardware Access Denied. Please enable camera in browser settings.");
        }
    };
    ...
    const captureAndUpload = async () => {
        ...
        try {
            ...
            formDataUpload.append("image", blob, "vendor-broadcast.jpg");
            ...
            if (uploadRes.ok) {
                ...
                const postRes = await fetch(getApiUrl("/api/stories"), {
                    ...
                    body: JSON.stringify({
                        ...
                        caption: formData.caption || "Live update from our store!"
                    }),
                });
                ...
                <div className="fixed inset-0 z-[2000] bg-black text-white p-6 flex flex-col items-center justify-center animate-in fade-in duration-300">
                    <div className="w-full max-w-md space-y-8">
                        <div className="flex justify-between items-center">
                            ...
                            <h2 className="text-sm font-black uppercase tracking-[0.3em] text-secondary">Broadcast Live</h2>
                                    ...
                                    <div className="absolute inset-x-0 bottom-10 flex flex-col items-center px-10 space-y-6">
                                        {!stream ? (
                                            <div className="flex flex-col items-center gap-6">
                                                <button
                                                    onClick={startCamera}
                                                    className="bg-secondary text-primary px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-widest"
                                                >
                                                    Initialize Lens
                                                </button>
                                            </div>
