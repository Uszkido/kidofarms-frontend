    ...
    return (
        <div className="min-h-screen bg-neutral-50 px-6 py-24">
            <div className="container mx-auto max-w-4xl">
                <div className="mb-12">
                    <Link href="/dashboard/vendor" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-primary/40 hover:text-primary transition-all mb-4">
