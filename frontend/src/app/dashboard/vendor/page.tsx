                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div className="bg-primary p-8 rounded-[2.5rem] shadow-xl text-white space-y-6 relative overflow-hidden group">
                                ...
                                <div className="relative">
                                    ...
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mt-2">Elite Merchant Status</p>
                                    <ChevronRight className="absolute bottom-0 right-0 text-white/20 group-hover:text-secondary group-hover:translate-x-2 transition-all" size={32} />
                                </div>
                            </div>
                        </div>
